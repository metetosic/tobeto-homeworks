...
--
-- TOC entry 4965 (class 1262 OID 25322)
-- Name: Ecommerce; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "Ecommerce" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';
